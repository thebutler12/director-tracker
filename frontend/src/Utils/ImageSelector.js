...
const serviceIconMap = {
  ...
  'Amazon-VPC_Endpoints_light-bg': 'AWS::VPC::Endpoint',
  'Amazon-EC2_VPC_Endpoints_light-bg': 'AWS::EC2::VPCEndpoint',
  ...
  'Amazon-Elastic-Container-Service_Service_light-bg': 'AWS::ECS::Service',
  'Amazon-Elastic-Container-Service_Task_light-bg': 'AWS::ECS::Task',
  'ECS-Task-Definition-light-bg': 'AWS::ECS::TaskDefinition',
